...
The GitHub issue transport can invoke any tool currently advertised by the DPSR MCP server without duplicating MCP tool definitions in the remote agent.
